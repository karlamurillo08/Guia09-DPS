...
cardStyle: { backgroundColor: 'blue'} // Cambia el color de fondoaquí
}} />
<Tab.Screen name="Audio Recorder" component={AudioRecorder}options={{headerShown: false,cardStyle: { backgroundColor: '#000'} // Cambia el color de fondoaquí
}} />
</Tab.Navigator>
</NavigationContainer>
);
